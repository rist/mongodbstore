...
function Store(host, port, dbName, options) {
    ...
    function BaseQuery(type) {
        ...
        this.greater = function(property, value) {
            log.info(value);
            query.put(property, new BasicDBObject("$gt", value));
            return this;
        };

        this.greaterEquals = function(property, value) {
            query.put(property, new BasicDBObject("$gte", value));
            return this;
        };

        this.less = function(property, value) {
            query.put(property, new BasicDBObject("$lt", value));
            return this;
        };

        this.lessEquals = function(property, value) {
            query.put(property, new BasicDBObject("$lte", value));
            return this;
        };
        ...
        this.orderBy = function(property, direction) {
            // asecending = +1
            // descending = -1
            options.order.push(new BasicDBObject(value, direction))
            return this;
        };
